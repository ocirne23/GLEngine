...
export module Graphics.ITexture;

export enum class ETextureType
{
	TEX1D,
	TEX2D,
	TEX3D,
...
export enum class EMultisampleType
{
	NONE,
	MSAA_2X,
	MSAA_4X,
...
export enum class ETextureMinFilter
{
	NEAREST,
	LINEAR,
...
export enum class ETextureCompareMode
{
	NONE,
	COMPARE_R_TO_TEXTURE,
};

export enum class ETextureMagFilter
{
	NEAREST,
	LINEAR,
};

export enum class ETextureWrap
{
	CLAMP_TO_EDGE,
	MIRRORED_REPEAT,
	REPEAT,
...
export enum class ETextureComponentFormat
{
	F8,
	F16,
	F32,
...
export enum class ETexturePixelDataFormat
{
	UNSIGNED_BYTE,
	BYTE,
	UNSIGNED_SHORT,
...
export struct TextureSizeSettings
{
	uint width = 0;
	uint height = 0;
	uint depth = 0;
...
export struct TextureFilterSettings
{
...
export struct TextureSettings
{
	TextureSizeSettings size;
	TextureFilterSettings filter;
};

export class GRAPHICS_API ITexture
{
public:
