...
export module Graphics.GLTexture;

import Graphics.ITexture;
import Graphics.GLUtils;

export class GLTexture final : public ITexture
{
public:
	...
	virtual void setOptions(const TextureSettings& settings) override
	{
		m_settings = settings;
...
private:
	...
	void setupTextureStorage(const TextureSizeSettings& size)
	{
