...
#include "3rdparty/entityx/3rdparty/simplesignal.h"
...
typedef Simple::Signal<void (void*)> EventSignal;
...
class EventManager : entityx::help::NonCopyable {
 public:
   ...
   *       void receive(Explosion &explosion) {
   *       }
   *     };
   *
 ...
 private:
  ...
  struct EventCallbackWrapper {
    EventCallbackWrapper(std::function<void(E &)> callback) : callback(callback) {}
